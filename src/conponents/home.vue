                  ...
                  <div class="welare_content lt">
                      ...
                      <div class="welare_box">
                        <div class="welare_data">
                            <ul class="dis_flex welare_data_box">
                              <li class="welare_width">
                                  <p class="welare_text_title">9.0%</p>
                                  <p class="welare_text_content">历史年化收益率</p>
                              </li>
                              <li class="welare_width">
                                  <p class="welare_text_title">100,000,000 <span class="unit">元</span></p>
                                  <p class="welare_text_content">历史年化收益率</p>
                              </li>
                               <li class="welare_width welare_center">
                                  <p class="welare_text_title">30<span class="unit">天</span></p>
                                  <p class="welare_text_content">期限</p>
                              </li>
                            </ul>
                        </div>
                        <div class="progress_box dis_flex">
                            <div class="progress_left dis_flex">
                                <div class="progress">
                                    <b></b>
                                </div>
                            ...
                            <div class="progress_right">
                                <div class="settle">已结清</div>
                            </div>
                        </div>
                      </div>
                  </div>
                  <div class="welare_content_rt lt">
                      <div >
                        <img src="../../static/image/home/bank_depository_20180925.png" alt="">
                      </div>
                      <div>
                        <img src="../../static/image/home/xszy_ggpic_new.png" alt="">
                      </div>
                  </div>
              </div>
...
export default {
  ...
  mounted() {
    ...
    function carouseTime() {
      clearTime = setInterval(function() {
        tops -= 50;
        carlist.animate({ top: tops + "px" }, animateTime);
        if (tops < (carinx - 2) * -50) {
            animateTime = 0;
            tops = 50;
        }else{
  ...
  filters: {
    focus: function(value) {
      ...
      if (result.indexOf(".") >= 0){
        var numrt = result.substr(result.indexOf("."),3);
        var numlt = result.substr(0,result.indexOf("."));
        var numlt = numlt.substr(0,numlt.lastIndexOf(","));
        result = numlt + numrt;
        return result;
      } else {
        return result;
